    ...
    var body: some View {
        @State var notetext = ""
                ...
                ZStack {
                    ...
                    Text(" شعرت بأنها تعكس مشاعري في اللحظات الصعبة والجميلة. كلمات الشاعر عن المطر أعادت لي إحساس الأمل والهدوء في زحام الأفكار. كانت بمثابة راحة لروحي، وأعجبتني جدًا!")
                        .font(.headline)
